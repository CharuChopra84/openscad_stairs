...
module staircase_full(core_radius,step_width,
step_depth,num_per_rev,num_revs, overlap_angle) 
{
...
module staircase(core_radius,step_width,
step_depth,num_per_rev,num_revs, overlap_angle)
{
	assign(step_angle = 360 /num_per_rev)
	for (i = [0:num_per_rev *num_revs-1])
	assign( angle = i * step_angle,height = i * step_depth)
...
$fa=0.1;
$fs=0.5;
staircase_full(10,20,10,15,15,10);